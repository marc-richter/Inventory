...
import PersonalizationReminder from './PersonalizationReminder'
...
const NAV = [
  ...
  { to: '/schluesselbuende', label: 'Schlüsselbünde', iconKey: 'key', caps: ['issues'] },
  { to: '/meine-geraete', label: 'Meine Geräte', iconKey: 'toolbox' },
